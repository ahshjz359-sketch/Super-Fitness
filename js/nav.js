...
------------------------------------------------------------------ */
const PAGE_MAP = [
  { en: 'index.html',            ar: 'index-ar.html',          key: 'home' },
...
const isArabic = currentFile.endsWith('-ar.html') || currentFile.endsWith('2.html');
...
function buildNav() {
  ...
  // كود توجيه الشعار بناءً على اللغة الحالية
...
function switchLanguage(){
  if(!currentEntry) {
    window.location.href = isArabic ? "index.html" : "index-ar.html";
    return;
  }
...
function injectStyle(){
  ...
  style.id = "sf-style";
  style.textContent = `
  .navbar a.nav-active{ border-bottom:2px solid #ff7a18; padding-bottom:3px; }
  #lang-switcher{ border:1px solid #ff7a18; color:#ff7a18 !important; padding:3px 10px; border-radius:3px; }
  #lang-switcher:hover{ background:#ff7a18; color:#fff !important; }
  html[lang="ar"] .navbar{ flex-direction:row-reverse; }
  html[lang="ar"] .navbar ul{ flex-direction:row-reverse; }
  `;
